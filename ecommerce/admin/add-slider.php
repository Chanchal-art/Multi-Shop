        ...
        <div class="content">
            ...
            <?php
                ...
                if(isset($_POST['btn']))
                {
                    ...
                    $img=rand(0000,99999).basename($_FILES['slider']['name']);
                    $temp=$_FILES['slider']['tmp_name'];
                    $path ="image/";
                    $dir =$path.$img;
                    ...
                    $slid = "INSERT INTO slider(Sliderimage,Title,Detail)values('$dir','$title','$detail')";
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="bg-secondary rounded h-100 p-4">
                                ...
                                <form action=""method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <label class="form-label">Add slider</label>
